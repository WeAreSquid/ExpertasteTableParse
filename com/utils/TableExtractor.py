...
class TableExtractor:
    ...
    def main_execution(self):
        self.read_image()
        self.store_process_image("0_original{}.jpg".format(self.suffix), self.image)
        self.convert_image_to_grayscale()
        self.store_process_image("1_grayscaled{}.jpg".format(self.suffix), self.grayscale_image)
        self.threshold_image()
        self.store_process_image("3_thresholded{}.jpg".format(self.suffix), self.thresholded_image)
        self.invert_image()
        self.store_process_image("4_inverted{}.jpg".format(self.suffix), self.inverted_image)
        self.dilate_image()
        self.store_process_image("5_dilated{}.jpg".format(self.suffix), self.dilated_image)
        self.close_image()
        self.store_process_image("6_closed{}.jpg".format(self.suffix), self.closed_image)
        self.find_contours()
